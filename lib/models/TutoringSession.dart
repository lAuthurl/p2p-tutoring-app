...
class TutoringSession extends amplify_core.Model {
  ...
  String toString() {
    ...
    buffer.write(
      "maxStudents=" +
          (_maxStudents != null ? _maxStudents.toString() : "null") +
          ", ",
    );
    buffer.write(
      "enrolledCount=" +
          (_enrolledCount != null ? _enrolledCount.toString() : "null") +
          ", ",
    );
    buffer.write(
  ...
  TutoringSession copyWithModelFieldValues({
    ...
    return TutoringSession._internal(
      ...
      enrolledCount:
          enrolledCount == null ? this.enrolledCount : enrolledCount.value,
  ...
  static final ENROLLEDCOUNT = amplify_core.QueryField(
