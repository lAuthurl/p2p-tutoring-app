...
class BookingItem extends amplify_core.Model {
  ...
  BookingItemModelIdentifier get modelIdentifier {
      return BookingItemModelIdentifier(
        id: id
      );
  }
  ...
  String toString() {
    ...
    buffer.write("booking=" + (_booking != null ? _booking!.toString() : "null") + ", ");
    ...
    buffer.write("negotiatedPrice=" + (_negotiatedPrice != null ? _negotiatedPrice!.toString() : "null") + ", ");
    buffer.write("applyDiscount=" + (_applyDiscount != null ? _applyDiscount!.toString() : "null") + ", ");
    buffer.write("isPhysical=" + (_isPhysical != null ? _isPhysical!.toString() : "null") + ", ");
  ...
  BookingItem copyWithModelFieldValues({
    ...
    return BookingItem._internal(
      ...
      negotiatedPrice: negotiatedPrice == null ? this.negotiatedPrice : negotiatedPrice.value,
      applyDiscount: applyDiscount == null ? this.applyDiscount : applyDiscount.value,
      isPhysical: isPhysical == null ? this.isPhysical : isPhysical.value,
      serviceTitle: serviceTitle == null ? this.serviceTitle : serviceTitle.value,
    ...
    : id = json['id'],
      ...
      _booking = json['booking'] != null
        ? json['booking']['serializedData'] != null
          ? Booking.fromJson(new Map<String, dynamic>.from(json['booking']['serializedData']))
          : Booking.fromJson(new Map<String, dynamic>.from(json['booking']))
        : null,
  ...
  static final amplify_core.QueryModelIdentifier<BookingItemModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<BookingItemModelIdentifier>();
  ...
  static final NEGOTIATEDPRICE = amplify_core.QueryField(fieldName: "negotiatedPrice");
  static final APPLYDISCOUNT = amplify_core.QueryField(fieldName: "applyDiscount");
  static final ISPHYSICAL = amplify_core.QueryField(fieldName: "isPhysical");
  static final SERVICETITLE = amplify_core.QueryField(fieldName: "serviceTitle");
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ...
      amplify_core.ModelIndex(fields: const ["bookingId", "createdAt"], name: "byBooking")
    ];
 ...
 */
class BookingItemModelIdentifier implements amplify_core.ModelIdentifier<BookingItem> {
  final String id;

  /** Create an instance of BookingItemModelIdentifier using [id] the primary key. */
  const BookingItemModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is BookingItemModelIdentifier &&
      id == other.id;
  }
