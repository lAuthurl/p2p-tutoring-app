...
class UserFavorite extends amplify_core.Model {
  ...
  UserFavoriteModelIdentifier get modelIdentifier {
    return UserFavoriteModelIdentifier(id: id);
  }
  ...
  static final amplify_core.QueryModelIdentifier<UserFavoriteModelIdentifier>
  MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<UserFavoriteModelIdentifier>();
 ...
 */
class UserFavoriteModelIdentifier
    implements amplify_core.ModelIdentifier<UserFavorite> {
  final String id;

  /** Create an instance of UserFavoriteModelIdentifier using [id] the primary key. */
  const UserFavoriteModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is UserFavoriteModelIdentifier && id == other.id;
  }
