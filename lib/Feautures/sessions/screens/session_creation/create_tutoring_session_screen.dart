        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // ── Step 4: Student Capacity ───────────────────────────────
              Obx(() {
                final limited = controller.hasStudentLimit.value;
                return _StepCard(
                  step: 4,
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    limited
                                        ? "Session closes when full"
                                        : "Toggle to set a max student count",
                                    style: theme.textTheme.labelSmall?.copyWith(
                                      color: colorScheme.onSurface.withValues(
                                        alpha: 0.5,
                                      ),
                            ...
                            Switch(
                              value: limited,
                              onChanged: (val) {
                                controller.hasStudentLimit.value = val;
                                if (!val) controller.maxStudents.clear();
                              },
                            ),
                          ],
                        ),
                      ...
                      // Max students field — animates in/out
                      AnimatedSize(
                        duration: const Duration(milliseconds: 250),
                        curve: Curves.easeInOut,
                        child:
                            !limited
                                ...
                                : Padding(
                                  ...
                                  child: TextFormField(
                                    controller: controller.maxStudents,
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: "e.g. 10",
                                      helperText:
                                          "Session hides from browse when full",
                                      border: _inputBorder(),
                                      enabledBorder: _inputBorder(
                                        color: colorScheme.outline.withValues(
                                          alpha: 0.3,
                                    ...
                                    validator: (v) {
                                      if (!controller.hasStudentLimit.value) {
                                        return null;
                                      }
                                      if (v == null || v.trim().isEmpty) {
                                        return "Enter max number of students";
                                      }
